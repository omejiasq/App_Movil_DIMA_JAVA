...
public class RecoverAccountActivity extends AppCompatActivity implements ISetup {
    ...
    public void setClickEvents() {
        binding.btnLogin.setOnClickListener(view -> Utils.showToastMessage(context, context.getString(R.string.message_function_disabled)));
        binding.header.vBack.setOnClickListener(view -> finish());
    }
}